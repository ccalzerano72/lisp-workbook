...
\teorico{Cap.~3}{Tail recursion e accumulatori; App.~A: Lo stack delle chiamate}
...
\teorico{Cap.~3}{Tail recursion; App.~A: Lo stack delle chiamate}
...
\teorico{Cap.~4}{Composizione e applicazione parziale}
\end{essbox}
...
\teorico{Cap.~4}{Closure: funzioni con memoria}
\end{essbox}
...
\teorico{Cap.~5}{Alberi binari e BST}
\end{stdbox}
...
\teorico{Cap.~6}{Come funziona una macro; backquote}
\end{stdbox}
...
\teorico{Cap.~6}{Macro pratiche; \fn{\&body}}
\end{stdbox}
...
\teorico{Cap.~6}{Cattura di variabile e \fn{gensym}}
\end{colbox}
