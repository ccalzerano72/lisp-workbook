...
\exspieg{Stessa tecnica dell'es.~51: introdurre un accumulatore che accumula
la somma parziale. La ricorsione scende da \fn{a} verso \fn{b} (o viceversa)
aggiungendo ad ogni passo il valore corrente.
Vedi la \hyperref[nota:tailrec]{nota sulla tail recursion} in fondo al capitolo.}
\nopagebreak
\begin{lstlisting}
...
gli stessi valori moltissime volte. Con due accumulatori (\fn{a} = F(k),
\fn{b} = F(k+1)) si avanza di un passo alla volta senza ridondanze,
ottenendo $O(n)$ in tempo e $O(1)$ in spazio.
