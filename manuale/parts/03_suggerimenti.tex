...
%  Label: \label{hint:N}
%  Link bidirezionali: ogni hint -> esercizio e soluzione
%  Policy listing: accentati come ASCII
% =============================================================
...
\noindent
Questa sezione contiene suggerimenti per gli esercizi di
difficolta' \treStelle\ o superiore.
Prima di leggere il suggerimento, fai almeno un tentativo
autonomo: anche una soluzione parziale o sbagliata e' piu'
utile di leggere subito la risposta.

\medskip
\noindent
Ogni suggerimento indica il percorso verso la soluzione
senza svelare il codice. Per gli esercizi \quattroStelle/\cinqueStelle\
e' presente anche una sezione di ragionamento esteso.

% =============================================================
\section*{Capitolo 1 — Fondamenti}
% =============================================================

\label{hint:17}
\begin{hintbox}{17}
\textbf{Somma delle cifre} \quad \hyperref[ex:17]{$\leftarrow$ Esercizio} \quad \hyperref[sol:17]{$\rightarrow$ Soluzione}
...
% =============================================================
\section*{Capitolo 2 — Liste}
% =============================================================

\label{hint:40}
\begin{hintbox}{40}
\textbf{Append} \quad \hyperref[ex:40]{$\leftarrow$ Esercizio} \quad \hyperref[sol:40]{$\rightarrow$ Soluzione}
...
\label{hint:41}
\begin{hintbox}{41}
\textbf{Remove-first} \quad \hyperref[ex:41]{$\leftarrow$ Esercizio} \quad \hyperref[sol:41]{$\rightarrow$ Soluzione}
...
\label{hint:49}
\begin{hintbox}{49}
\textbf{Run-length encoding} \quad \hyperref[ex:49]{$\leftarrow$ Esercizio} \quad \hyperref[sol:49]{$\rightarrow$ Soluzione}

\textbf{Encode:} tieni traccia dell'elemento corrente e del contatore.
...
\textbf{Decode:} per ogni coppia \fn{(n elem)}, genera \fn{n}
...
\label{hint:50}
\begin{hintbox}{50}
\textbf{Remove-duplicates*} \quad \hyperref[ex:50]{$\leftarrow$ Esercizio} \quad \hyperref[sol:50]{$\rightarrow$ Soluzione}
...
% =============================================================
\section*{Capitolo 3 — Ricorsione avanzata}
% =============================================================

\label{hint:54}
\begin{hintbox}{54}
\textbf{Fibonacci O(n)} \quad \hyperref[ex:54]{$\leftarrow$ Esercizio} \quad \hyperref[sol:54]{$\rightarrow$ Soluzione}
...
\label{hint:55}
\begin{hintbox}{55}
\textbf{Flatten*} \quad \hyperref[ex:55]{$\leftarrow$ Esercizio} \quad \hyperref[sol:55]{$\rightarrow$ Soluzione}
...
(defun flatten* (tree)
  (cond
    ...
    (t (append (flatten* (car tree))
               (flatten* (cdr tree))))))
\end{lstlisting}
\textbf{Attenzione:} ricorrere su \fn{car} e \fn{cdr} separatamente,
non su \fn{(car tree)} e \fn{(cdr tree)} come lista.
\end{hintbox}

\label{hint:56}
\begin{hintbox}{56}
\textbf{Tree-depth} \quad \hyperref[ex:56]{$\leftarrow$ Esercizio} \quad \hyperref[sol:56]{$\rightarrow$ Soluzione}
...
\label{hint:60}
\begin{hintbox}{60}
\textbf{Sostituzione profonda} \quad \hyperref[ex:60]{$\leftarrow$ Esercizio} \quad \hyperref[sol:60]{$\rightarrow$ Soluzione}
...
\label{hint:61}
\begin{hintbox}{61}
\textbf{Power-fast} \quad \hyperref[ex:61]{$\leftarrow$ Esercizio} \quad \hyperref[sol:61]{$\rightarrow$ Soluzione}
...
\label{hint:64}
\begin{hintbox}{64}
\textbf{Crivello di Eratostene} \quad \hyperref[ex:64]{$\leftarrow$ Esercizio} \quad \hyperref[sol:64]{$\rightarrow$ Soluzione}
...
\label{hint:65}
\begin{hintbox}{65}
\textbf{Fattori primi} \quad \hyperref[ex:65]{$\leftarrow$ Esercizio} \quad \hyperref[sol:65]{$\rightarrow$ Soluzione}
...
\label{hint:67}
\begin{hintbox}{67}
\textbf{Raggruppa in blocchi} \quad \hyperref[ex:67]{$\leftarrow$ Esercizio} \quad \hyperref[sol:67]{$\rightarrow$ Soluzione}
...
% =============================================================
\section*{Capitolo 4 — Higher-order e closure}
% =============================================================

\label{hint:75}
\begin{hintbox}{75}
\textbf{Cifre in intero} \quad \hyperref[ex:75]{$\leftarrow$ Esercizio} \quad \hyperref[sol:75]{$\rightarrow$ Soluzione}
...
\label{hint:77}
\begin{hintbox}{77}
\textbf{Regola di Horner} \quad \hyperref[ex:77]{$\leftarrow$ Esercizio} \quad \hyperref[sol:77]{$\rightarrow$ Soluzione}
...
\label{hint:83}
\begin{hintbox}{83}
\textbf{Raggruppa per chiave} \quad \hyperref[ex:83]{$\leftarrow$ Esercizio} \quad \hyperref[sol:83]{$\rightarrow$ Soluzione}
...
\label{hint:85}
\begin{hintbox}{85}
\textbf{Compose} \quad \hyperref[ex:85]{$\leftarrow$ Esercizio} \quad \hyperref[sol:85]{$\rightarrow$ Soluzione}
...
\label{hint:86}
\begin{hintbox}{86}
\textbf{Partial application} \quad \hyperref[ex:86]{$\leftarrow$ Esercizio} \quad \hyperref[sol:86]{$\rightarrow$ Soluzione}
...
\label{hint:87}
\begin{hintbox}{87}
\textbf{Closure con stato} \quad \hyperref[ex:87]{$\leftarrow$ Esercizio} \quad \hyperref[sol:87]{$\rightarrow$ Soluzione}
...
\label{hint:89}
\begin{hintbox}{89}
\textbf{Generatore Fibonacci con closure} \quad \hyperref[ex:89]{$\leftarrow$ Esercizio} \quad \hyperref[sol:89]{$\rightarrow$ Soluzione}
...
\label{hint:91}
\begin{hintbox}{91}
\textbf{Memoize} \quad \hyperref[ex:91]{$\leftarrow$ Esercizio} \quad \hyperref[sol:91]{$\rightarrow$ Soluzione}
...
% =============================================================
\section*{Capitolo 5 — Strutture dati}
% =============================================================

\label{hint:94}
\begin{hintbox}{94}
\textbf{Frequenze con alist} \quad \hyperref[ex:94]{$\leftarrow$ Esercizio} \quad \hyperref[sol:94]{$\rightarrow$ Soluzione}
...
\label{hint:97}
\begin{hintbox}{97}
\textbf{Frequenza dei caratteri} \quad \hyperref[ex:97]{$\leftarrow$ Esercizio} \quad \hyperref[sol:97]{$\rightarrow$ Soluzione}
...
\label{hint:98}
\begin{hintbox}{98}
\textbf{Unione di hash table} \quad \hyperref[ex:98]{$\leftarrow$ Esercizio} \quad \hyperref[sol:98]{$\rightarrow$ Soluzione}
...
\label{hint:99}
\begin{hintbox}{99}
\textbf{Inverti hash table} \quad \hyperref[ex:99]{$\leftarrow$ Esercizio} \quad \hyperref[sol:99]{$\rightarrow$ Soluzione}
...
\label{hint:102}
\begin{hintbox}{102}
\textbf{Trasposta di matrice} \quad \hyperref[ex:102]{$\leftarrow$ Esercizio} \quad \hyperref[sol:102]{$\rightarrow$ Soluzione}
...
\label{hint:104}
\begin{hintbox}{104}
\textbf{Moltiplicazione di matrici (opzionale)} \quad \hyperref[ex:104]{$\leftarrow$ Esercizio} \quad \hyperref[sol:104]{$\rightarrow$ Soluzione}
...
\label{hint:108}
\begin{hintbox}{108}
\textbf{BST: inserimento e ricerca} \quad \hyperref[ex:108]{$\leftarrow$ Esercizio} \quad \hyperref[sol:108]{$\rightarrow$ Soluzione}
...
\label{hint:109}
\begin{hintbox}{109}
\textbf{Traversal dell'albero} \quad \hyperref[ex:109]{$\leftarrow$ Esercizio} \quad \hyperref[sol:109]{$\rightarrow$ Soluzione}
...
\label{hint:112}
\begin{hintbox}{112}
\textbf{Albero bilanciato?} \quad \hyperref[ex:112]{$\leftarrow$ Esercizio} \quad \hyperref[sol:112]{$\rightarrow$ Soluzione}
...
\label{hint:114}
\begin{hintbox}{114}
\textbf{Coda FIFO} \quad \hyperref[ex:114]{$\leftarrow$ Esercizio} \quad \hyperref[sol:114]{$\rightarrow$ Soluzione}
...
\label{hint:115}
\begin{hintbox}{115}
\textbf{Valida parentesi} \quad \hyperref[ex:115]{$\leftarrow$ Esercizio} \quad \hyperref[sol:115]{$\rightarrow$ Soluzione}
...
\label{hint:118}
\begin{hintbox}{118}
\textbf{DFS su grafo} \quad \hyperref[ex:118]{$\leftarrow$ Esercizio} \quad \hyperref[sol:118]{$\rightarrow$ Soluzione}
...
\label{hint:119}
\begin{hintbox}{119}
\textbf{BFS su grafo} \quad \hyperref[ex:119]{$\leftarrow$ Esercizio} \quad \hyperref[sol:119]{$\rightarrow$ Soluzione}
...
\label{hint:120}
\begin{hintbox}{120}
\textbf{Conta parole} \quad \hyperref[ex:120]{$\leftarrow$ Esercizio} \quad \hyperref[sol:120]{$\rightarrow$ Soluzione}
...
% =============================================================
\section*{Capitolo 6 — Macro}
% =============================================================

\label{hint:121}
\begin{hintbox}{121}
\textbf{Macro quando} \quad \hyperref[ex:121]{$\leftarrow$ Esercizio} \quad \hyperref[sol:121]{$\rightarrow$ Soluzione}
...
\label{hint:122}
\begin{hintbox}{122}
\textbf{Macro while} \quad \hyperref[ex:122]{$\leftarrow$ Esercizio} \quad \hyperref[sol:122]{$\rightarrow$ Soluzione}
...
\label{hint:123}
\begin{hintbox}{123}
\textbf{Macro for} \quad \hyperref[ex:123]{$\leftarrow$ Esercizio} \quad \hyperref[sol:123]{$\rightarrow$ Soluzione}
...
% =============================================================
\section*{Capitolo 7 — Backtracking e algoritmi}
% =============================================================

\label{hint:124}
\begin{hintbox}{124}
\textbf{Subsets} \quad \hyperref[ex:124]{$\leftarrow$ Esercizio} \quad \hyperref[sol:124]{$\rightarrow$ Soluzione}
...
\label{hint:125}
\begin{hintbox}{125}
\textbf{Permutazioni} \quad \hyperref[ex:125]{$\leftarrow$ Esercizio} \quad \hyperref[sol:125]{$\rightarrow$ Soluzione}
...
\label{hint:126}
\begin{hintbox}{126}
\textbf{Combinazioni} \quad \hyperref[ex:126]{$\leftarrow$ Esercizio} \quad \hyperref[sol:126]{$\rightarrow$ Soluzione}
...
\label{hint:127}
\begin{hintbox}{127}
\textbf{Somma a target} \quad \hyperref[ex:127]{$\leftarrow$ Esercizio} \quad \hyperref[sol:127]{$\rightarrow$ Soluzione}
...
\label{hint:128}
\begin{hintbox}{128}
\textbf{Parentesi bilanciate generate} \quad \hyperref[ex:128]{$\leftarrow$ Esercizio} \quad \hyperref[sol:128]{$\rightarrow$ Soluzione}
...
\label{hint:129}
\begin{hintbox}{129}
\textbf{Merge sort} \quad \hyperref[ex:129]{$\leftarrow$ Esercizio} \quad \hyperref[sol:129]{$\rightarrow$ Soluzione}
...
\label{hint:130}
\begin{hintbox}{130}
\textbf{Quicksort} \quad \hyperref[ex:130]{$\leftarrow$ Esercizio} \quad \hyperref[sol:130]{$\rightarrow$ Soluzione}
...
\label{hint:131}
\begin{hintbox}{131}
\textbf{Torri di Hanoi} \quad \hyperref[ex:131]{$\leftarrow$ Esercizio} \quad \hyperref[sol:131]{$\rightarrow$ Soluzione}
...
\label{hint:132}
\begin{hintbox}{132}
\textbf{Problema dello zaino} \quad \hyperref[ex:132]{$\leftarrow$ Esercizio} \quad \hyperref[sol:132]{$\rightarrow$ Soluzione}
...
\label{hint:133}
\begin{hintbox}{133}
\textbf{Labirinto} \quad \hyperref[ex:133]{$\leftarrow$ Esercizio} \quad \hyperref[sol:133]{$\rightarrow$ Soluzione}
...
\label{hint:134}
\begin{hintbox}{134}
\textbf{N-regine} \quad \hyperref[ex:134]{$\leftarrow$ Esercizio} \quad \hyperref[sol:134]{$\rightarrow$ Soluzione}

\textbf{Rappresentazione:} usa un vettore di \fn{n} elementi dove
\fn{(aref board col)} e' la riga in cui si trova la regina
nella colonna \fn{col}. Stai posizionando una regina per colonna.

\textbf{Pruning:} prima di posizionare la regina nella colonna \fn{col}
...
\label{hint:135}
\begin{hintbox}{135}
\textbf{Sudoku} \quad \hyperref[ex:135]{$\leftarrow$ Esercizio} \quad \hyperref[sol:135]{$\rightarrow$ Soluzione}
...
\label{hint:136}
\begin{hintbox}{136}
\textbf{Cammino del cavallo} \quad \hyperref[ex:136]{$\leftarrow$ Esercizio} \quad \hyperref[sol:136]{$\rightarrow$ Soluzione}
...
% =============================================================
\section*{Capitolo 8 — Stringhe e I/O}
% =============================================================

\label{hint:139}
\begin{hintbox}{139}
\textbf{Palindromo robusto} \quad \hyperref[ex:139]{$\leftarrow$ Esercizio} \quad \hyperref[sol:139]{$\rightarrow$ Soluzione}
...
\label{hint:140}
\begin{hintbox}{140}
\textbf{Anagrammi} \quad \hyperref[ex:140]{$\leftarrow$ Esercizio} \quad \hyperref[sol:140]{$\rightarrow$ Soluzione}
...
% =============================================================
\section*{Capitolo 9 — Parsing e interprete}
% =============================================================

\label{hint:142}
\begin{hintbox}{142}
\textbf{Calcolatrice RPN} \quad \hyperref[ex:142]{$\leftarrow$ Esercizio} \quad \hyperref[sol:142]{$\rightarrow$ Soluzione}
...
\label{hint:143}
\begin{hintbox}{143}
\textbf{Valutatore di espressioni} \quad \hyperref[ex:143]{$\leftarrow$ Esercizio} \quad \hyperref[sol:143]{$\rightarrow$ Soluzione}
...
\label{hint:144}
\begin{hintbox}{144}
\textbf{Mini-interprete con variabili} \quad \hyperref[ex:144]{$\leftarrow$ Esercizio} \quad \hyperref[sol:144]{$\rightarrow$ Soluzione}
...
% =============================================================
\section*{Capitolo 10 — Progetti}
% =============================================================

\label{hint:146}
\begin{hintbox}{146}
\textbf{Tris} \quad \hyperref[ex:146]{$\leftarrow$ Esercizio} \quad \hyperref[sol:146]{$\rightarrow$ Soluzione}
...
\label{hint:147}
\begin{hintbox}{147}
\textbf{Gioco della vita} \quad \hyperref[ex:147]{$\leftarrow$ Esercizio} \quad \hyperref[sol:147]{$\rightarrow$ Soluzione}
...
\label{hint:148}
\begin{hintbox}{148}
\textbf{Mini sistema gestionale} \quad \hyperref[ex:148]{$\leftarrow$ Esercizio} \quad \hyperref[sol:148]{$\rightarrow$ Soluzione}
