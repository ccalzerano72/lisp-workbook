...
\textbf{Simboli:} nomi interned. La virgoletta singola \fn{'} previene
la valutazione:\nopagebreak
...
prima del ritorno. Allegro CL ottimizza la tail recursion (TCO),
...
(nreverse '(a b c))         ; -> (C B A)    (distruttivo!)
...
(remove-duplicates '(a b a c b)) ; -> (A C B) o (B C A)
\end{lstlisting}
...
; creazione
(make-array 5)                              ; vettore non inizializzato
