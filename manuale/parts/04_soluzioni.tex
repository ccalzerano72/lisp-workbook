      ...
      (multiple-value-bind (val found)
        ...
        (if found
            ...
            (setf (gethash args cache)
                  (apply funzione args)))))))
\end{lstlisting}
\textbf{Nota:} questa versione memoizza le chiamate \emph{esterne}.
Per memoizzare una funzione ricorsiva occorre che la funzione stessa
chiami la versione memoizzata, non se stessa:
\begin{lstlisting}
