...
% ---- ESEMPIO ----
% Argomento opzionale: titolo (default "Esempio")
...
% ---- CONFRONTO: box per comparazioni con altri linguaggi ----
% Bordo sinistro colorato, sfondo caldo, testo descrittivo
\definecolor{boxCfFrame}{RGB}{160,80,20}    % marrone-arancio
