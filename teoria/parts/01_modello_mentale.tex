...
\begin{attenzione}
\textbf{All'inizio, non usare \fn{setf}.}
Nei linguaggi imperativi scrivi \texttt{x = x + 1} per aggiornare \texttt{x}.
In Lisp, invece di modificare un valore esistente, crei un nuovo binding:
\begin{lstlisting}
...
(let ((x-nuovo (+ x 1)))
  ...)
\end{lstlisting}
\fn{setf} esiste ed è legittimo.
Ma se lo usi subito come default stai scrivendo C, non Lisp.
\end{attenzione}
