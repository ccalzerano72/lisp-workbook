...
eseguiti sempre. \fn{if} è una forma speciale (o macro) proprio
perché controlla \emph{quale} ramo valutare.}
\end{concetto}
...
Le macro Lisp lavorano direttamente sull'AST del programma,
con tutto il linguaggio disponibile.
\end{tcolorbox}
